...
public class Vista {
	...
	public void reservarLab() {
		 ...
		 * hasta las 22:00 //No se me ocurre cómo hacerlo. La idea es coger el
		 * día que esté seleccionado y si la hora que toque para //ese día para
		 * la correspondiente vuelta del for está libre entonces la añadimos a
		 * la ComboBox }
		 */
		...
		// Me queda también hacer las funciones que hagan las cosas
